	...
	)
{
	...
	if (vdf_enable){}
		...
		while(1){
			/*one shot*/
			rtl_write_dword(rtlpriv, 0xcb8, 0x00100000);/* cb8[20] 將 SI/PI 使用權切給 iqk_dpk module*/
			rtl_write_dword(rtlpriv, 0xeb8, 0x00100000);/* cb8[20] 將 SI/PI 使用權切給 iqk_dpk module*/
	...
	if (vdf_enable) {}
		...
		while(1){
		    /* one shot*/
				...
				rtl_set_bbreg(hw, 0x82c, BIT(31), 0x1); /* [31] = 1 --> Page C1*/
				rtl_write_dword(rtlpriv, 0xcb8, 0x00300000);/*cb8[20] 將 SI/PI 使用權切給 iqk_dpk module*/
			...
			if (tx1_finish){
				...
				rtl_set_bbreg(hw, 0x82c, BIT(31), 0x1); /*[31] = 1 --> Page C1*/
				rtl_write_dword(rtlpriv, 0xeb8, 0x00300000);/*cb8[20] 將 SI/PI 使用權切給 iqk_dpk module*/
				rtl_write_dword(rtlpriv, 0xeb8, 0x00100000);/* cb8[20] 將 SI/PI 使用權切給 iqk_dpk module*/
			}
